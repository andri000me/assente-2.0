<h3 class="page-header">Konfirmasi Izin Mahasiswa</h3>
<?php
  ...
  // Notifikasi Absen
  	if (isset($_GET['ab'])) {
  		if ($_GET['ab']==1) {
  			echo "<div class='alert alert-warning'><strong>Izin telah dikonfirmasi.</strong></div>";
  		} elseif($_GET['ab']==2) {
  			echo "<div class='alert alert-danger'><strong>Gagal, Silahkan Coba Kembali!</strong></div>";
  		} elseif($_GET['ab']==3) {
        echo "<div class='alert alert-warning'><strong>Izin berhasil ditolak.</strong></div>";
      } 
  	} 
    ...
    if ($query->num_rows!==0) {
        ...
        echo "<div class='alert alert-danger'><strong>Tidak ada permintaan Izin.</strong></div>";
    }
?>