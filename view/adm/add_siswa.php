<h3 class="page-header">Tambah Mahasiswa Baru</h3>
<?php 
	if (isset($_GET['st'])) {
		if ($_GET['st']==1) {
...
<form class="form-horizontal" role="form" style="width:80%" onSubmit="return validasi()" name="formulir" method="post" action="./model/proses.php">
  <div class="form-group">
    <label class="control-label col-sm-2" for="name">NIM:</label>
    <div class="col-sm-10">
      <input type="number" class="form-control" name="nis" placeholder="Masukan NIM" required>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="sklh" placeholder="Masukan Alamat" required>
    </div>
