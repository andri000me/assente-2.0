<h3 class='page-header'>Daftar Mahasiswa RPL B</h3>
<?php 
if (isset($_GET['st'])) {
        if ($_GET['st']==1) {
            ...
            echo "<table class='table table-striped' style='width:70%'>
                    ...
                    while ($get_siswa = $query_siswa->fetch_assoc()) {
                        ...
                        echo "<tr>
                                ...
                                <td><a href='siswa&id_siswa=$id_siswa' title='Edit $name'>Edit info</a> &bullet; <a style='cursor:pointer' onclick='hapusSiswa($id_siswa)' >Hapus Mahasiswa</a></td>
                            </tr>";
                    }
                   // $conn->close();
                    echo "</tbody></table>";
