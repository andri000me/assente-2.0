<h3 class="page-header">Tambah Dosen Baru</h3>
<?php 
	if (isset($_GET['st'])) {
		if ($_GET['st']==1) {
...
<form class="form-horizontal" role="form" style="width:80%" onSubmit="return validasi()" name="formulir" method="post" action="./model/proses.php">
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default" name="add_dos">Simpan</button>
      <button type="reset" class="btn btn-warning" name="add_dos">Reset</button>
    </div>
  </div>
</form>
